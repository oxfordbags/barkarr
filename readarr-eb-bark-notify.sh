...
Indexer: ${readarr_release_indexer}"
    ...
    Download)
        title="✅ ReadarrEB: Book Downloaded"
    ...
    Upgrade)
        title="⬆️ ReadarrEB: Book Upgraded"
...
New Quality: ${readarr_bookfile_quality}"
    ...
    Health)
        ...
        title="$emoji ReadarrEB Health: $readarr_health_issue_level"
...
Wiki: $readarr_health_issue_wiki"
    ...
    Test)
        title="🧪 ReadarrEB: Test Notification"
